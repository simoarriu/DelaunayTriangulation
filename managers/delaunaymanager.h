...
#include <drawable/delaunaytriangulationdrawable.h>

#include <algorithms/delaunaytriangulationalgorithm.h>

#include <drawable/voronoidiagramdrawable.h>
...
private:
    ...
    //Declare the algorithm (used to obtain the triangulation)
    cg3::DelaunayTriangulationAlgorithm delaunayTriangulation;
    //Declare the drawable of the traingulation
    cg3::DelaunayTriangulationDrawable delaunayDrawable;
    //Declare the drawable of voronoi diagram
    cg3::VoronoiDiagramDrawable voronoiDiagram;

    //Iterator for scan the points in input
    std::vector<cg3::Point2Dd>::const_iterator it;
...
private slots:
    ...
    //Methods used to manage the voronoi diagram state
